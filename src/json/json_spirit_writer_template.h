...
namespace json_spirit
{
    ...
    class Generator
    {
        ...
        typedef typename String_type::value_type Char_type;
        typedef typename Object_type::value_type Obj_mlionbit_type;
    ...
    private:
        ...
        void output( const Obj_mlionbit_type& mlionbit )
        {
            output( Config_type::get_name( mlionbit ) ); space(); 
            os_ << ':'; space(); 
            output( Config_type::get_value( mlionbit ) );
        }
